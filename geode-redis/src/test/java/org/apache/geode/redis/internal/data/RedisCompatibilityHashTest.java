...
public class RedisCompatibilityHashTest {
  ...
  public void confirmSerializationIsStable() throws IOException, ClassNotFoundException {
    RedisCompatibilityHash o1 = createRedisHash("k1", "v1", "k2", "v2");
    o1.setExpirationTimestampNoDelta(1000);
    HeapDataOutputStream out = new HeapDataOutputStream(100);
    DataSerializer.writeObject(o1, out);
    ByteArrayDataInput in = new ByteArrayDataInput(out.toByteArray());
    RedisCompatibilityHash o2 = DataSerializer.readObject(in);
    assertThat(o2).isEqualTo(o1);
  }

  private RedisCompatibilityHash createRedisHash(String k1, String v1, String k2, String v2) {
    ...
    return new RedisCompatibilityHash(elements);
  }
  ...
  public void equals_returnsFalse_givenDifferentExpirationTimes() {
    RedisCompatibilityHash o1 = createRedisHash("k1", "v1", "k2", "v2");
    o1.setExpirationTimestampNoDelta(1000);
    RedisCompatibilityHash o2 = createRedisHash("k1", "v1", "k2", "v2");
  ...
  public void equals_returnsFalse_givenDifferentValueBytes() {
    RedisCompatibilityHash o1 = createRedisHash("k1", "v1", "k2", "v2");
    o1.setExpirationTimestampNoDelta(1000);
    RedisCompatibilityHash o2 = createRedisHash("k1", "v1", "k2", "v3");
  ...
  public void equals_returnsTrue_givenDifferentEmptyHashes() {
    RedisCompatibilityHash o1 = new RedisCompatibilityHash(Collections.emptyList());
    RedisCompatibilityHash o2 = RedisCompatibilityHash.NULL_REDIS_HASH;
    assertThat(o1).isEqualTo(o2);
    assertThat(o2).isEqualTo(o1);
  }
  ...
  public void hset_stores_delta_that_is_stable() throws IOException {
    Region<ByteArrayWrapper, RedisCompatibilityData> region = Mockito.mock(Region.class);
    RedisCompatibilityHash o1 = createRedisHash("k1", "v1", "k2", "v2");
