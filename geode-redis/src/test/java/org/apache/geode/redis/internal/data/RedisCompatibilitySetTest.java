...
public class RedisCompatibilitySetTest {
  ...
  public void confirmSerializationIsStable() throws IOException, ClassNotFoundException {
    RedisCompatibilitySet o1 = createRedisSet(1, 2);
    o1.setExpirationTimestampNoDelta(1000);
    HeapDataOutputStream out = new HeapDataOutputStream(100);
    DataSerializer.writeObject(o1, out);
    ByteArrayDataInput in = new ByteArrayDataInput(out.toByteArray());
    RedisCompatibilitySet o2 = DataSerializer.readObject(in);
    assertThat(o2).isEqualTo(o1);
  }

  private RedisCompatibilitySet createRedisSet(int m1, int m2) {
    return new RedisCompatibilitySet(Arrays.asList(
  ...
  public void equals_returnsFalse_givenDifferentExpirationTimes() {
    RedisCompatibilitySet o1 = createRedisSet(1, 2);
    o1.setExpirationTimestampNoDelta(1000);
    RedisCompatibilitySet o2 = createRedisSet(1, 2);
  ...
  public void equals_returnsFalse_givenDifferentValueBytes() {
    RedisCompatibilitySet o1 = createRedisSet(1, 2);
    o1.setExpirationTimestampNoDelta(1000);
    RedisCompatibilitySet o2 = createRedisSet(1, 3);
  ...
  public void equals_returnsTrue_givenDifferentEmptySets() {
    RedisCompatibilitySet o1 = new RedisCompatibilitySet(Collections.emptyList());
    RedisCompatibilitySet o2 = RedisCompatibilitySet.NULL_REDIS_SET;
    assertThat(o1).isEqualTo(o2);
    assertThat(o2).isEqualTo(o1);
  }
