...
import static org.apache.geode.redis.internal.RedisCompatibilityConstants.ERROR_NO_SUCH_KEY;
...
public class RenameExecutor extends AbstractExecutor {
  ...
  public RedisCompatibilityResponse executeCommand(Command command,
    ...
    if (!redisCompatibilityKeyCommands.rename(key, newKey)) {
      return RedisCompatibilityResponse.error(ERROR_NO_SUCH_KEY);
    }
