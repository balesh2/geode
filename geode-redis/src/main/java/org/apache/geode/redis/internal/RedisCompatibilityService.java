...
public class RedisCompatibilityService implements CacheService, ResourceEventsListener {
  private static final Logger logger = LogService.getLogger();
  private RedisCompatibilityServer redisServer;
  ...
  private void startRedisServer(InternalCache cache) {
    ...
    if (system.getConfig().getRedisEnabled()) {
      ...
      this.redisServer = new RedisCompatibilityServer(bindAddress, port, cache);
    }
  }
  ...
  public Class<? extends CacheService> getInterface() {
    return RedisCompatibilityService.class;
  }
