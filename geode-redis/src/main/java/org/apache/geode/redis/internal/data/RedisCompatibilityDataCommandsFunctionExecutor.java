 ...
 */
public abstract class RedisCompatibilityDataCommandsFunctionExecutor {
  protected final CommandHelper helper;

  protected RedisCompatibilityDataCommandsFunctionExecutor(CommandHelper helper) {
    this.helper = helper;
  }

  protected Region<ByteArrayWrapper, RedisCompatibilityData> getRegion() {
  ...
  protected RedisCompatibilityData getRedisData(ByteArrayWrapper key) {
