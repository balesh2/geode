...
import org.apache.geode.redis.internal.gfsh.RedisCompatibilityCommandFunction;
import org.apache.geode.redis.internal.netty.NettyRedisCompatibilityServer;
...
import org.apache.geode.redis.internal.statistics.RedisCompatibilityStats;
...
public class RedisCompatibilityServer {
  /**
  ...
  private final NettyRedisCompatibilityServer nettyRedisCompatibilityServer;
   ...
   */
  public RedisCompatibilityServer(String bindAddress, int port, InternalCache cache) {
    ...
    RedisCompatibilityCommandFunction.register();
    ...
    nettyRedisCompatibilityServer =
        new NettyRedisCompatibilityServer(() -> cache.getInternalDistributedSystem().getConfig(),
  ...
  public void setAllowUnsupportedCommands(boolean allowUnsupportedCommands) {
    ...
    configRegion.put(RedisCompatibilityServer.ENABLE_REDIS_UNSUPPORTED_COMMANDS_PARAM,
  ...
  private static NativeRedisStats createStats(InternalCache cache) {
    InternalDistributedSystem system = cache.getInternalDistributedSystem();
    StatisticsClock statisticsClock =
        StatisticsClockFactory.clock(true);

    return new NativeRedisStats(statisticsClock,
        new RedisCompatibilityStats(system.getStatisticsManager(),
            "redisStats",
            statisticsClock));
  }

  @VisibleForTesting
  public NativeRedisStats getStats() {
    return redisStats;
  }
  ...
  public int getPort() {
    return nettyRedisCompatibilityServer.getPort();
  }
  ...
  public synchronized void shutdown() {
    if (!shutdown) {
      ...
      nettyRedisCompatibilityServer.stop();
