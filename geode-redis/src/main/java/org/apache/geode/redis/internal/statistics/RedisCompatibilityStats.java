...
public class RedisCompatibilityStats {
  @Immutable
  private static final StatisticsType type;
  @Immutable
  private static final EnumMap<RedisCompatibilityCommandType, Integer> completedCommandStatIds =
      new EnumMap<>(RedisCompatibilityCommandType.class);
  @Immutable
  private static final EnumMap<RedisCompatibilityCommandType, Integer> timeCommandStatIds =
      new EnumMap<>(RedisCompatibilityCommandType.class);
  ...
  public RedisCompatibilityStats(StatisticsFactory factory, String textId,
  ...
  private static void fillListWithTimeCommandDescriptors(StatisticsTypeFactory factory,
    ...
    for (RedisCompatibilityCommandType command : RedisCompatibilityCommandType.values()) {
