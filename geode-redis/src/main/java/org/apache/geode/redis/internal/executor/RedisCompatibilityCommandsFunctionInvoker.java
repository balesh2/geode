...
public abstract class RedisCompatibilityCommandsFunctionInvoker {
  protected final Region<ByteArrayWrapper, RedisCompatibilityData> region;

  protected RedisCompatibilityCommandsFunctionInvoker(
