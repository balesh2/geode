...
public class RedisCompatibilityCommand extends GfshCommand {
  ...
  public ResultModel enableUnsupportedCommands(
    ...
    List<CliFunctionResult> results =
        executeAndGetFunctionResult(new RedisCompatibilityCommandFunction(),
            enableUnsupportedCommands, members);
