...
import org.apache.geode.redis.internal.executor.hash.RedisCompatibilityHashCommands;

public class RedisCompatibilityHashCommandsFunctionExecutor
    extends RedisCompatibilityDataCommandsFunctionExecutor implements
    RedisCompatibilityHashCommands {

  public RedisCompatibilityHashCommandsFunctionExecutor(
      CommandHelper helper) {
    super(helper);
  }

  private RedisCompatibilityHash getRedisHash(ByteArrayWrapper key, boolean updateStats) {
