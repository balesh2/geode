...
public class RedisCompatibilityString extends AbstractRedisCompatibilityData {
  public static final NullRedisCompatibilityString NULL_REDIS_STRING =
      new NullRedisCompatibilityString();

  private int appendSequence;

  private ByteArrayWrapper value;

  public RedisCompatibilityString(ByteArrayWrapper value) {
    this.value = value;
  }

  // for serialization
  public RedisCompatibilityString() {}
  ...
  public long incr(Region<ByteArrayWrapper, RedisCompatibilityData> region, ByteArrayWrapper key)
    ...
    if (longValue == Long.MAX_VALUE) {
      throw new ArithmeticException(RedisCompatibilityConstants.ERROR_OVERFLOW);
    }
    longValue++;
  ...
  private long parseValueAsLong() {
    try {
      ...
      throw new NumberFormatException(RedisCompatibilityConstants.ERROR_NOT_INTEGER);
    }
  }
  ...
  private BigDecimal parseValueAsBigDecimal() {
    ...
    if (valueString.contains(" ")) {
      throw new NumberFormatException(RedisCompatibilityConstants.ERROR_NOT_A_VALID_FLOAT);
    }
    try {
  ...
  @Override
  public RedisCompatibilityDataType getType() {
    return RedisCompatibilityDataType.REDIS_STRING;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RedisCompatibilityString)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
    }
    RedisCompatibilityString that = (RedisCompatibilityString) o;
