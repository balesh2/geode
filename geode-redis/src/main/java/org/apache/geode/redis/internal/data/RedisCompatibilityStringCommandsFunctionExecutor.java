...
public class RedisCompatibilityStringCommandsFunctionExecutor
    extends RedisCompatibilityDataCommandsFunctionExecutor
    implements
    RedisCompatibilityStringCommands {

  public RedisCompatibilityStringCommandsFunctionExecutor(
      CommandHelper helper) {
    super(helper);
  }

  private RedisCompatibilityString getRedisString(ByteArrayWrapper key, boolean updateStats) {
    return helper.getRedisString(key, updateStats);
  }

  private RedisCompatibilityString getRedisStringIgnoringType(ByteArrayWrapper key,
      boolean updateStats) {
