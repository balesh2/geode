...
public abstract class AbstractRedisCompatibilityData implements RedisCompatibilityData {
  ...
  @Override
  public void setExpirationTimestamp(Region<ByteArrayWrapper, RedisCompatibilityData> region,
  ...
  @Override
  public boolean rename(Region<ByteArrayWrapper, RedisCompatibilityData> region,
  ...
  @Override
  public long pttl(Region<ByteArrayWrapper, RedisCompatibilityData> region, ByteArrayWrapper key) {
  ...
  @Override
  public int persist(Region<ByteArrayWrapper, RedisCompatibilityData> region,
  ...
  protected void storeChanges(Region<ByteArrayWrapper, RedisCompatibilityData> region,
      ByteArrayWrapper key,
      DeltaInfo deltaInfo) {
    if (deltaInfo != null) {
      if (removeFromRegion()) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof AbstractRedisCompatibilityData)) {
      return false;
    }
    AbstractRedisCompatibilityData that = (AbstractRedisCompatibilityData) o;
