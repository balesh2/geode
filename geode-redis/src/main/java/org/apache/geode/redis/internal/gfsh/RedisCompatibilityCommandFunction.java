...
public class RedisCompatibilityCommandFunction extends CliFunction<Boolean> {

  public static void register() {
    FunctionService.registerFunction(new RedisCompatibilityCommandFunction());
  }
  ...
  public CliFunctionResult executeFunction(FunctionContext<Boolean> context) {
    ...
    RedisCompatibilityService geodeRedisService = cache.getService(RedisCompatibilityService.class);
