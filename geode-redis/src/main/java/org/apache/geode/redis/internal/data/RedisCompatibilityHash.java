...
import static org.apache.geode.redis.internal.RedisCompatibilityConstants.ERROR_OVERFLOW;
...
public class RedisCompatibilityHash extends AbstractRedisCompatibilityData {
  public static final RedisCompatibilityHash NULL_REDIS_HASH = new NullRedisCompatibilityHash();
  private HashMap<ByteArrayWrapper, ByteArrayWrapper> hash;

  public RedisCompatibilityHash(List<ByteArrayWrapper> fieldsToSet) {
    hash = new HashMap<>();
  ...
  public int hset(Region<ByteArrayWrapper, RedisCompatibilityData> region, ByteArrayWrapper key,
  ...
  public int hdel(Region<ByteArrayWrapper, RedisCompatibilityData> region, ByteArrayWrapper key,
  ...
  public long hincrby(Region<ByteArrayWrapper, RedisCompatibilityData> region, ByteArrayWrapper key,
  ...
  public BigDecimal hincrbyfloat(Region<ByteArrayWrapper, RedisCompatibilityData> region,
  ...
  public RedisCompatibilityDataType getType() {
    return RedisCompatibilityDataType.REDIS_HASH;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RedisCompatibilityHash)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
    }
    RedisCompatibilityHash redisCompatibilityHash = (RedisCompatibilityHash) o;
    return Objects.equals(hash, redisCompatibilityHash.hash);
  }
