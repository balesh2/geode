...
public class RedisCompatibilitySetCommandsFunctionExecutor
    extends RedisCompatibilityDataCommandsFunctionExecutor implements
    RedisCompatibilitySetCommands {

  public RedisCompatibilitySetCommandsFunctionExecutor(
      CommandHelper helper) {
    super(helper);
  }

  private RedisCompatibilitySet getRedisSet(ByteArrayWrapper key, boolean updateStats) {
